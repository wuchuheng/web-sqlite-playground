export function registerOpfsAsync(sqlite3ApiBootstrap) {
    sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
        const installOpfsVfs = function callee(options) {
            ...
            const thePromise = new Promise(function (
                ...
                const W = new Worker(new URL(proxyUri, import.meta.url));
                setTimeout(() => {
        ...
        sqlite3ApiBootstrap.initializersAsync.push(async (sqlite3) => {
            try {
