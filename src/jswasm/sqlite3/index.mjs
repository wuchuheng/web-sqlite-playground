...
import { createStructBinderFactory } from "./bootstrap/struct-binder-factory.mjs";
import { createWhWasmUtilInstaller } from "./bootstrap/wh-wasm-util-installer.mjs";
import { registerCoreApi } from "./bootstrap/register-core-api.mjs";
import { registerVersionInfo } from "./bootstrap/register-version-info.mjs";
import { registerOo1 } from "./bootstrap/register-oo1.mjs";
import { registerWorker1 } from "./bootstrap/register-worker1.mjs";
import { registerVfs } from "./bootstrap/register-vfs.mjs";
import { registerVtab } from "./bootstrap/register-vtab.mjs";
import { registerOpfsAsync } from "./bootstrap/register-opfs-async.mjs";
import { registerOpfsSahpool } from "./bootstrap/register-opfs-sahpool.mjs";
...
var sqlite3InitModule = (() => {
    ...
    return function (moduleArg = {}) {
        ...
        Module.runSQLite3PostLoadInit = function (EmscriptenModule) {
            ...
            globalThis.WhWasmUtilInstaller = createWhWasmUtilInstaller();
            globalThis.Jaccwabyt = createStructBinderFactory();

            registerCoreApi(globalThis.sqlite3ApiBootstrap);
            registerVersionInfo(globalThis.sqlite3ApiBootstrap);
            registerOo1(globalThis.sqlite3ApiBootstrap);
            registerWorker1(globalThis.sqlite3ApiBootstrap);
            registerVfs(globalThis.sqlite3ApiBootstrap);
            registerVtab(globalThis.sqlite3ApiBootstrap);
            registerOpfsAsync(globalThis.sqlite3ApiBootstrap);
            registerOpfsSahpool(globalThis.sqlite3ApiBootstrap);
            if ("undefined" !== typeof Module) {
